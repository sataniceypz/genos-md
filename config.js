...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'GENOS',
    ...
    BOT_INFO: process.env.BOT_INFO || 'GENOS;EYPZ;918111939974;https://i.imgur.com/98YEwrf.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'GENOS;EYPZ;https://i.imgur.com/98YEwrf.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'GENOS;EYPZ' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '918111939974,0',
       DEBUG: DEBUG
};
